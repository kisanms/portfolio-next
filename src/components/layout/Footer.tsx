...
const Footer = () => {
  ...
  const socialLinks = [
    ...
    {
      name: "Twitter",
      url: "https://x.com/MajumdarKishan",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="20"
    ...
    {
      name: "Instagram",
      url: "https://www.instagram.com/kisanms/",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="20"
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          >
            ...
            <ul className="flex flex-wrap gap-2 justify-center md:justify-end">
              <li className="px-2 py-1 bg-gray-800/50 rounded-full text-xs text-gray-400 border border-gray-700">
                Next.js
              </li>
              <li className="px-2 py-1 bg-gray-800/50 rounded-full text-xs text-gray-400 border border-gray-700">
                TypeScript
